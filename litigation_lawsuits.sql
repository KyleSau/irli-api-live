...
--
-- Host: localhost    Database: litigation
-- ------------------------------------------------------
...
CREATE TABLE `lawsuits` (
  ...
  `next_steps` mediumtext NOT NULL,
  `documents` varchar(45) DEFAULT NULL,
  `lead_counsel` tinyint NOT NULL,
...
-- Dump completed on 2022-07-26  2:15:49
